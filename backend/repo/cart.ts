...
export const updateCartData = async(email:string,title:string,date:string|null,fieldData:any,field:string)=>{
...
export const saveCart = async(title:string,price:string,email:string,quantity:string)=>{
...
export const deleteCart = async (email:string,title:string,date:string|null) => {
    const sqlQuery:string = `DELETE FROM shoppingcart.cart WHERE email='${email}' AND date='${date}' AND title='${title}'`;
    await runQuery(sqlQuery);  
}

export const findProductTitle = async (email:string,title:string,date:string):Promise<Iproduct[]> => {
    const sqlQuery:string = `SELECT * FROM shoppingcart.cart WHERE email ='${email}' AND title='${title}' AND date='${date}'`;
    return await runQuery(sqlQuery); 
}